...
_BSE_MIDCAP_EXTRA: list[str] = [
    ...
    "MCDOWELL-N.NS", "SAIL.NS", "HFCL.NS", "RATNAMANI.NS", "WHIRLPOOL.NS",
...
_BSE_SMALLCAP_EXTRA: list[str] = [
    "ALKYLAMINE.NS", "BALRAMCHIN.NS", "CHAMBLFERT.NS", "DCB.NS", "DELTACORP.NS",
    "ESTER.NS", "HOCL.NS", "IGPL.NS", "INFIBEAM.NS", "KITEX.NS",
    "NUVOCO.NS", "ORIENTCEM.NS", "RBLBANK.NS", "SAKSOFT.NS", "SNOWMAN.NS",
    "STOVEKRAFT.NS", "VAIBHAVGBL.NS", "VARROC.NS", "WOCKPHARMA.NS", "ZENITHME.NS",
    # Quality growth mid/smallcaps worth tracking
    "LXCHEM.NS", "MASTECH.NS", "MOLD-TEK.NS", "NAVNETEDUL.NS", "NIITLTD.NS",
]
...
_NIFTY500_EXTENSION: list[str] = [
    # IT & Software
    "LTIM.NS", "OFSS.NS", "MPHASIS.NS", "HEXAWARE.NS", "CYIENT.NS",
    "TATAELXSI.NS", "ZENSAR.NS", "NIIT.NS",
    # Pharma & Healthcare
    "AUROPHARMA.NS", "ALKEM.NS", "BIOCON.NS", "GLAND.NS", "LALPATHLAB.NS",
    "METROPOLIS.NS", "NATCOPHARM.NS", "SYNGENE.NS", "PIRAMALPHA.NS",
    # Banks & Finance
    "FEDERALBNK.NS", "CSBBANK.NS", "KARURVYSYA.NS", "SOUTHBANK.NS",
    "BANDHANBNK.NS", "EQUITASBNK.NS", "UJJIVAN.NS", "FINCABLES.NS",
    "ANGEL.NS", "MOTILALOFS.NS", "ICICIGI.NS", "HDFCLIFE.NS", "SBILIFE.NS",
    # Consumer & FMCG
    "PNBHOUSING.NS", "CANFINHOME.NS", "MFSL.NS", "CHOLAHLDNG.NS",
    "VENKEY.NS", "VSTMD.NS", "JUBLFOOD.NS", "WESTLIFE.NS",
    # Industrials & Engineering
    "BHARAT.NS", "TIINDIA.NS", "GREAVESCOT.NS", "KCPLTD.NS", "KSB.NS",
    "POWERINDIA.NS", "TDPOWERSYS.NS", "TRIVENI.NS", "UNOMINDA.NS",
    # Chemicals & Materials
    "ALKYLAMINE.NS", "AAVAS.NS", "BALRAMCHIN.NS", "CHAMBAL.NS", "GNFC.NS",
    "PIDILITIND.NS", "SOLARINDS.NS", "SRF.NS", "TATACHEM.NS", "VINATIORG.NS",
    # Real Estate & Infrastructure
    "PRESTIGE.NS", "PHOENIXLTD.NS", "SOBHA.NS", "MAHINDCIE.NS", "NHAI.NS",
    # Energy
    "ADANITRANS.NS", "CESC.NS", "JPPOWER.NS", "RPOWER.NS", "TATAPOWER.NS",
    # Auto & Components
    "ASHOKLEY.NS", "BALKRISIND.NS", "BHARATFORG.NS", "MOTHERSON.NS", "SUNDRM.NS",
    "TITAGARH.NS", "BOSCHLTD.NS",
    # Telecom & Media
    "IDEA.NS", "TATACOMM.NS",
    # Logistics & Infrastructure
    "DELHIVERY.NS", "MAHLOG.NS", "ALLCARGO.NS",
]
